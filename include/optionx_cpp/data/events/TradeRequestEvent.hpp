#pragma once
#ifndef OPTIONX_HEADER_DATA_EVENTS_TRADE_REQUEST_EVENT_HPP_INCLUDED
#define OPTIONX_HEADER_DATA_EVENTS_TRADE_REQUEST_EVENT_HPP_INCLUDED
...
namespace optionx::events {
    ...
    class TradeRequestEvent : public utils::Event {
    public:
        ...
        std::type_index type() const override {
            return typeid(TradeRequestEvent);
        }

        const char* name() const override {
            return "TradeRequestEvent";
        }
    };

} // namespace optionx::events

#endif // OPTIONX_HEADER_DATA_EVENTS_TRADE_REQUEST_EVENT_HPP_INCLUDED
