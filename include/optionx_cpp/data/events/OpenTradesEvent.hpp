#pragma once
#ifndef OPTIONX_HEADER_DATA_EVENTS_OPEN_TRADES_EVENT_HPP_INCLUDED
#define OPTIONX_HEADER_DATA_EVENTS_OPEN_TRADES_EVENT_HPP_INCLUDED

namespace optionx::events {

    /// \class OpenTradesEvent
    /// \brief Represents an event to notify about changes in the open trades count.
    class OpenTradesEvent : public utils::Event {
    public:
...
#endif // OPTIONX_HEADER_DATA_EVENTS_OPEN_TRADES_EVENT_HPP_INCLUDED
