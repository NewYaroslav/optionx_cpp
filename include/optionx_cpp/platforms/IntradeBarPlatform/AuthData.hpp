#pragma once
#ifndef OPTIONX_HEADER_PLATFORMS_INTRADE_BAR_PLATFORM_AUTH_DATA_HPP_INCLUDED
#define OPTIONX_HEADER_PLATFORMS_INTRADE_BAR_PLATFORM_AUTH_DATA_HPP_INCLUDED
...
namespace optionx::platforms::intrade_bar {
    ...
    public:
        ...
        AuthData() :
            user_agent(OPTIONX_DEFAULT_BROWSER_USER_AGENT),
            accept_language(OPTIONX_DEFAULT_ACCEPT_LANGUAGE),
        ...
        void from_json(const nlohmann::json& j) override {
            try {
                ...
                settings_switch_active_trade_buffer_ms = j.value(
                    ...
                    settings_switch_active_trade_buffer_ms);
                active_trades_close_buffer_ms = j.value(
                    "active_trades_close_buffer_ms",
                    active_trades_close_buffer_ms);
        ...
        std::pair<bool, std::string> validate() const override {
            ...
            if (active_trades_close_buffer_ms < 0) {
                return { false, "Active trades close buffer must be non-negative" };
            }
...
#endif // OPTIONX_HEADER_PLATFORMS_INTRADE_BAR_PLATFORM_AUTH_DATA_HPP_INCLUDED
