...
namespace intrade_bar {
    ...
    protected:
        ...
        CurrencyType get_account_currency(const AccountInfoRequest& request) override final {
            return currency;
        }
        ...
        AccountType get_account_type(const AccountInfoRequest& request) override final {
            return account_type;
        }
        ...
        double get_min_amount(const AccountInfoRequest& request) {
        ...
        double get_max_amount(const AccountInfoRequest& request) {
