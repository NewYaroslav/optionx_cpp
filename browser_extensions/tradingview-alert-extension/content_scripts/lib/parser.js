(function (root, factory) {
  ...
  const TRIGGER_PATTERNS = [
    ...
    { pattern: /\b(?:moving\s+up\s*%?)\b/i, value: "moving_up_pct" },
    { pattern: /\b(?:moving\s+up)\b/i, value: "moving_up" },
    { pattern: /\b(?:moving\s+down\s*%?)\b/i, value: "moving_down_pct" },
    { pattern: /\b(?:moving\s+down)\b/i, value: "moving_down" },
