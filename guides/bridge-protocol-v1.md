...
This file is the navigator for the Bridge Protocol v1 draft. The detailed
specification is split into focused files under `guides/bridge-protocol-v1/`.

The English version is canonical. The Russian files are maintained as a
synchronized translation for discussion and review convenience.

## Reading Order

1. [Overview](bridge-protocol-v1/overview.md)
...
- [Обзор](bridge-protocol-v1/overview.ru.md)
